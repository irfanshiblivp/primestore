...
import { Search, SlidersHorizontal, Package, Grid, Eye, Loader2 } from "lucide-react";
import Link from "next/link";

function PhysicalPageContent() {
    ...
    async function fetchProducts() {
      try {
        ...
        if (snapshot.exists()) {
          ...
          setAllProducts(mockProducts.map(normalizeProduct).filter((p) => p.type === "physical"));
        }
      } catch (error) {
  ...
  // Categories for physical products
      ...
      <main className="flex-1 bg-white text-neutral-800">
        <div className="mx-auto max-w-7xl px-6 py-12 sm:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-neutral-100 pb-8 mb-10 gap-6">
            <div>
              <span className="text-[10px] font-bold text-accent uppercase tracking-widest block mb-1.5 font-sans">Setup collection</span>
              <h1 className="font-serif text-3xl font-extrabold text-neutral-900 tracking-tight">Physical Product</h1>
              <p className="text-xs font-semibold text-neutral-450 mt-1 leading-relaxed">Exquisite hardware goods, custom desk pads, and luxury office items.</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
            ...
            <aside className="hidden lg:block space-y-8 pr-4 border-r border-neutral-100/80">
              ...
              <div className="border-t border-neutral-100/80 pt-6">
                ...
                <select
                  ...
                  className="w-full border border-neutral-200 rounded-xl px-3 py-2 text-xs font-semibold text-neutral-750 focus:outline-none focus:border-neutral-450 bg-white cursor-pointer"
                >
            ...
            <div className="lg:hidden flex items-center justify-between gap-4 border-b border-neutral-100 pb-4">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 border border-neutral-200 rounded-xl text-xs font-bold uppercase tracking-wider text-neutral-650 hover:bg-neutral-50 cursor-pointer"
              >
                    ...
                    >
                      <div>
                        ...
                        <div className="mt-3 space-y-1 px-1">
                          <h3 className="text-xs font-bold text-neutral-900 tracking-tight line-clamp-1 group-hover:text-accent transition-colors">
