    ...
    async function fetchProducts() {
      try {
        ...
        if (snapshot.exists()) {
          ...
          setAllProducts(mockProducts.map(normalizeProduct).filter((p) => p.type === "digital"));
        }
      } catch (error) {
      ...
      <main className="flex-1 bg-white text-neutral-800">
        <div className="mx-auto max-w-7xl px-6 py-12 sm:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-neutral-100 pb-8 mb-10 gap-6">
            <div>
              <span className="text-[10px] font-bold text-secondary uppercase tracking-widest block mb-1.5 font-sans">Digital Archives</span>
              <h1 className="font-serif text-3xl font-extrabold text-neutral-900 tracking-tight">Digital Products</h1>
              <p className="text-xs font-semibold text-neutral-450 mt-1 leading-relaxed">Direct software assets, development boilerplates, and online courses.</p>
            </div>
            ...
            <div className="lg:col-span-3">
              {loading ? (
                ...
                <div className="text-center py-20 bg-neutral-50/50 rounded-3xl border border-dashed border-neutral-205">
                  ...
                  <h3 className="font-bold text-sm text-neutral-800">No assets found</h3>
                      ...
                      <div className="mt-3 flex items-center justify-between pt-2 border-t border-neutral-50 px-1">
                        ...
                        <div className="flex gap-1">
                          ...
                          <button
                            ...
                            className="rounded-full bg-neutral-900 p-2 text-white hover:bg-neutral-850 transition-colors cursor-pointer"
                          >
